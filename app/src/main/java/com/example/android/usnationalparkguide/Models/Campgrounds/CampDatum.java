...
public class CampDatum implements Parcelable
{
    ...
    protected CampDatum(Parcel in) {
        ...
        in.readList(this.fees, (com.example.android.usnationalparkguide.Models.Campgrounds.Fee.class.getClassLoader()));
        ...
        in.readList(this.operatingHours, (com.example.android.usnationalparkguide.Models.Campgrounds.OperatingHour.class.getClassLoader()));
        ...
        in.readList(this.addresses, (com.example.android.usnationalparkguide.Models.Campgrounds.Address.class.getClassLoader()));
