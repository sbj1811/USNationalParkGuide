...
public class Datum implements Parcelable
{
    ...
    protected Datum(Parcel in) {
        ...
        in.readList(this.entranceFees, (com.example.android.usnationalparkguide.Models.Park.EntranceFee.class.getClassLoader()));
        this.directionsInfo = ((String) in.readValue((String.class.getClassLoader())));
        in.readList(this.entrancePasses, (com.example.android.usnationalparkguide.Models.Park.EntrancePass.class.getClassLoader()));
        ...
        in.readList(this.operatingHours, (com.example.android.usnationalparkguide.Models.Park.OperatingHour.class.getClassLoader()));
        this.latLong = ((String) in.readValue((String.class.getClassLoader())));
        this.description = ((String) in.readValue((String.class.getClassLoader())));
        in.readList(this.images, (com.example.android.usnationalparkguide.Models.Park.Image.class.getClassLoader()));
        ...
        in.readList(this.addresses, (com.example.android.usnationalparkguide.Models.Park.Address.class.getClassLoader()));
